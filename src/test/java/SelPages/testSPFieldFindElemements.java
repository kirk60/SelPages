 ...
 * @since 2018-12-02
 *
 * <h1>testSPFieldFindElemements</h1>
 * Exercise the findElements type processing
 */

public class testSPFieldFindElemements {
    ...
    private Object[][] testData = {
            ...
            {SPHelpers.TEXT, "textText"},
            {SPHelpers.TAG, "button", null},
